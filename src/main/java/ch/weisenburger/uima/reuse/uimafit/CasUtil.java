 ...
 */
package ch.weisenburger.uima.reuse.uimafit;
...
public class CasUtil {
     ...
     */
    public static final String UIMA_BUILTIN_JCAS_PREFIX = "org.apache.ch.weisenburger.uima.jcas.";
    ...
    public static Type getType(CAS aCas, String aTypename) {
        ...
        if (typeName.startsWith(UIMA_BUILTIN_JCAS_PREFIX)) {
            typeName = "ch.weisenburger.uima." + typeName.substring(UIMA_BUILTIN_JCAS_PREFIX.length());
        }
